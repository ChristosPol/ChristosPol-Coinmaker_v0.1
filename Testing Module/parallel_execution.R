...
tp <- data.frame(tp = c(0.005, 0.01, 0.015, 0.02, 0.025, 0.03, 1000), flag = 1)
sl <- data.frame(sl = c(0.005, 0.01, 0.015, 0.02, 0.025, 0.03, 1000), flag = 1)
...
i  <- 391
testing_params <- testing_params[390:395,]
all_results <- list()
start_time <- Sys.time()
